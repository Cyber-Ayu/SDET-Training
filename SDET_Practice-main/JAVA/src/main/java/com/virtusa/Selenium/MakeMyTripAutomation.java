...
public class MakeMyTripAutomation {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        interactWithElement(driver, By.xpath("/html/body/div[1]/div/div[2]/div/div/div/div/div[1]/ul/li[1]"), "click",
                null);
        interactWithElement(driver,
                By.xpath("/html/body/div/div/div[2]/div/div/div/div/div[2]/div[1]/div[1]/label/input"), "click", null);
        interactWithElement(driver, By.xpath("//input[@placeholder='From']"), "sendKeys", "Delhi");
        interactWithElement(driver,
                By.xpath("/html/body/div/div/div[2]/div/div/div/div/div[2]/div[1]/div[2]/label/input"), "click", null);
