              ...
              <ul>
                <li>
                  <a href="#" panel-name="test-xml-Suite" class="navigator-link ">
                    <span>C:\Users\ayush\IdeaProjects\ComprehensiveAssignment\src\test\java\com\compAssignment\testng.xml</span>
                  </a> <!-- navigator-link  -->
                </li>
                <li>
                  ...
                  <li>
                    ...
                    <div class="method-list-content passed suite-Suite">
                      <span>
                        ...
                        <a href="#" panel-name="suite-Suite" title="com.compAssignment.TestNG.SelectOneWayTest" class="method navigator-link" hash-for-method="testOneWayFlightSelection">testOneWayFlightSelection</a> <!-- method navigator-link -->
                      </span>
                      <br/>
                      <span>
                        <img src="passed.png" width="3%"/>
                        <a href="#" panel-name="suite-Suite" title="com.compAssignment.TestNG.VerifyLogoTest" class="method navigator-link" hash-for-method="verifyLogoPresence">verifyLogoPresence</a> <!-- method navigator-link -->
                      </span>
                      <br/>
    ...
    <div class="wrapper">
      <div class="main-panel-root">
        <div panel-name="suite-Suite" class="panel Suite">
          <div class="suite-Suite-class-passed">
            <div class="main-panel-header rounded-window-top">
              <img src="passed.png"/>
              <span class="class-name">com.compAssignment.TestNG.SelectOneWayTest</span>
            </div> <!-- main-panel-header rounded-window-top -->
            <div class="main-panel-content rounded-window-bottom">
              <div class="method">
                <div class="method-content">
                  <a name="testOneWayFlightSelection">
                  </a> <!-- testOneWayFlightSelection -->
                  <span class="method-name">testOneWayFlightSelection</span>
                </div> <!-- method-content -->
              </div> <!-- method -->
          ...
          <div class="suite-Suite-class-passed">
            <div class="main-panel-header rounded-window-top">
              <img src="passed.png"/>
              <span class="class-name">com.compAssignment.TestNG.VerifyLogoTest</span>
            </div> <!-- main-panel-header rounded-window-top -->
            <div class="main-panel-content rounded-window-bottom">
              <div class="method">
                <div class="method-content">
                  <a name="verifyLogoPresence">
                  </a> <!-- verifyLogoPresence -->
                  <span class="method-name">verifyLogoPresence</span>
                </div> <!-- method-content -->
              </div> <!-- method -->
            </div> <!-- main-panel-content rounded-window-bottom -->
          </div> <!-- suite-Suite-class-passed -->
        ...
        <div panel-name="test-xml-Suite" class="panel">
          <div class="main-panel-header rounded-window-top">
            <span class="header-content">C:\Users\ayush\IdeaProjects\ComprehensiveAssignment\src\test\java\com\compAssignment\testng.xml</span>
          </div> <!-- main-panel-header rounded-window-top -->
          <div class="main-panel-content rounded-window-bottom">
            <pre>
...
data.addRows(2);
data.setCell(0, 0, 0)
data.setCell(0, 1, 'testOneWayFlightSelection')
data.setCell(0, 2, 'com.compAssignment.TestNG.SelectOneWayTest')
data.setCell(0, 3, 18654);
data.setCell(1, 0, 1)
data.setCell(1, 1, 'verifyLogoPresence')
data.setCell(1, 2, 'com.compAssignment.TestNG.VerifyLogoTest')
data.setCell(1, 3, 70);
        ...
        <div panel-name="chronological-Suite" class="panel">
          ...
          <div class="main-panel-content rounded-window-bottom">
            <div class="chronological-class">
              <div class="chronological-class-name">com.compAssignment.TestNG.VerifyLogoTest</div> <!-- chronological-class-name -->
              ...
              <div class="test-method">
                <span class="method-name">verifyLogoPresence</span>
                <span class="method-start">8107 ms</span>
              </div> <!-- test-method -->
              <div class="configuration-method after">
                <span class="method-name">teardown</span>
                <span class="method-start">8179 ms</span>
              </div> <!-- configuration-method after -->
            </div> <!-- chronological-class -->
            <div class="chronological-class">
              <div class="chronological-class-name">com.compAssignment.TestNG.SelectOneWayTest</div> <!-- chronological-class-name -->
              <div class="configuration-method before">
                <span class="method-name">setup</span>
                <span class="method-start">9678 ms</span>
              </div> <!-- configuration-method before -->
              <div class="test-method">
                <span class="method-name">testOneWayFlightSelection</span>
                <span class="method-start">14613 ms</span>
              </div> <!-- test-method -->
              <div class="configuration-method after">
                <span class="method-name">tearDown</span>
                <span class="method-start">33268 ms</span>
              </div> <!-- configuration-method after -->
          </div> <!-- main-panel-content rounded-window-bottom -->
        </div> <!-- panel -->
      </div> <!-- main-panel-root -->
